      ...
      >
        ...
        <nav className="h-full flex items-center justify-center">
          <ul className="space-y-8 text-center" onClick={handleMenuClick}>
            ...
            <li><a href="#sobremi" className="text-gray-100 text-2xl hover:text-blue-400 transition-colors">SOBRE MÍ</a></li>
            <li><a href="#servicios" className="text-gray-100 text-2xl hover:text-blue-400 transition-colors">SERVICIOS</a></li>
            <li><a href="#contacto" className="text-gray-100 text-2xl hover:text-blue-400 transition-colors">CONTACTO</a></li>
            <li>
              <a 
                href="/assets/docs/CV JOSE LUIS.pdf" 
